         ...
         if (email) {
            ...
            auth.signInWithEmailLink(email, window.location.href)
                .then((result) => {
                    ...
                    // Clean up the URL by removing Firebase auth parameters
                    const url = new URL(window.location.href);
                    // Remove Firebase auth parameters
                    ['apiKey', 'oobCode', 'mode', 'continueUrl', 'lang'].forEach(param => {
            ...
            .catch((error) => {
                ...
                switch (error.code) {
                    ...
                    case 'auth/invalid-action-code':
                        errorMessage = 'The magic link is invalid. Please request a new one.';
                        break;
                    default:
                        errorMessage += ' ' + error.message;
                }
